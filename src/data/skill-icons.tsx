...
export const skillIcons: Record<string, ReactNode> = {
  ...
  "Next.js": <SiNextdotjs size={S} color="currentColor" />,
  ...
  "TanStack Query": <SiReactquery size={S} color="#FF4154" />,
  "Three.js / Potree": <SiThreedotjs size={S} color="currentColor" />,
  "Three.js": <SiThreedotjs size={S} color="currentColor" />,
  ...
  "Cloudflare R2": <SiCloudflare size={S} color="#F38020" />,
  "Cloudflare Workers": <SiCloudflare size={S} color="#F38020" />,
  NCP: <HiServer size={S} color="#03C75A" />,
  "Naver Cloud": <HiServer size={S} color="#03C75A" />,
  "NAVER Cloud Platform": <HiServer size={S} color="#03C75A" />,
  "NCP Cloud Functions": <HiServer size={S} color="#03C75A" />,
  ...
  // Architecture
  "Microservices Architecture (MSA)": <FaLayerGroup size={S} color="#A78BFA" />,
  "Serverless Architecture": <HiServer size={S} color="#22D3EE" />,
