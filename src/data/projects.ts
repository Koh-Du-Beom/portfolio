...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description:
      "3D 점군·GIS 기반 시설물 관리 플랫폼의 프론트엔드를 단독 개발하고, 오픈소스 Potree 뷰어를 비탈면 안전점검 업무에 맞게 대규모 커스터마이징.",
    bullets: [
    ...
    metrics: [
      { label: "프론트엔드 기여도", value: "98%" },
      { label: "Potree 기여도", value: "80%" },
    ],
  },
  {
    id: "infra-cloud",
    ...
    description: "전체 서비스의 배포·스토리지 아키텍처와 서버리스 유틸리티를 설계·운영.",
    bullets: [
      "GitHub Actions, Docker, nginx 기반 CI/CD 및 컨테이너 배포 환경 구축",
      "NCP → Cloudflare R2 마이그레이션 — 월 비용 60% 절감",
      "Cloudflare Workers 기반 Presigned URL 발급·이메일 전송 API와 3D 파이프라인 스토리지 설계",
    ],
    metrics: [
      { label: "비용 절감", value: "60%" },
      { label: "인프라 기여도", value: "100%" },
    ],
  },
  {
    id: "onprem",
    ...
    bullets: [
      "MinIO S3 L4 TCP Stream Proxy와 자체 CA TLS 종단으로 Presigned URL 서명 무결성 보존",
